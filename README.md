...
## Rust Docs
[Documentation is here.](https://docs.rs/derive-getters/0.2.1)
...
This crate can also handle structs with simple generic parameters and lifetime annotations. Check [docs](https://docs.rs/derive-getters/0.2.1) for further details.
```rust
#[derive(Getters)]
